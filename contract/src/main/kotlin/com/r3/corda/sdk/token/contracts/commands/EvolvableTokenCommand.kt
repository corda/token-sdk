...
/**
 * A standard set of commands for creating and updating [EvolvableToken]s. Additional commands can be added which
 ...
 * can just persist on the ledger even if they are not required any more.
 */
