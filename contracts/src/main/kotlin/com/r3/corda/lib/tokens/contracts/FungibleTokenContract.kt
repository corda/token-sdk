...
open class FungibleTokenContract : AbstractTokenContract<FungibleToken>(), DescribableContract {
    ...
    override fun verifyMove(
        ...
        val ourSummary = describeTransaction(inputs.map{ it.state}, outputs.map { it.state }, moveCommands, attachments, references)
    ...
    override fun describeTransaction(
        ...
        attachments: List<Attachment>,
        references: List<StateAndRef<ContractState>>): List<String> {
        return when(commands.first().value) {
