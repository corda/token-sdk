...
import com.r3.corda.sdk.token.contracts.utilities.sumTokenStateAndRefsOrZero
...
class TokenDriverTest {
    ...
    fun `beefy tokens integration test`() {
        driver(DriverParameters(
                ...
                extraCordappPackagesToScan = listOf("com.r3.corda.sdk.token.contracts", "com.r3.corda.sdk.token.workflow", "com.r3.corda.sdk.token.money"),
            ...
            val (issuer, nodeA, nodeB, notary) = listOf(
