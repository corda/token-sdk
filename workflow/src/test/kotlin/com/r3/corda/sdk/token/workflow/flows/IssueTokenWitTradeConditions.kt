...
object IssueTokenWithTradeConditions {
    @InitiatingFlow
    @StartableByRPC
    ...
    ) : IssueToken.Primary<T>(token, issueTo, notary, amount, session) {
    ...
    class Responder(otherSession: FlowSession) : IssueToken.Secondary(otherSession) {
