...
@Suspendable
fun List<AbstractParty>.toWellKnownPartiesExcludingUnknown(services: ServiceHub): List<Party> {
	return mapNotNull(services.identityService::wellKnownPartyFromAnonymous)
}
